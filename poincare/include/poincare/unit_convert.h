...
public:
  ...
  static UnitConvert Builder(Expression value, Expression unit) { return TreeHandle::FixedArityBuilder<UnitConvert, UnitConvertNode>(ArrayBuilder2<TreeHandle>(value, unit).array(), 2); }
