...
public:
  ...
  static InvNorm Builder(Expression child0, Expression child1, Expression child2) { return TreeHandle::FixedArityBuilder<InvNorm, InvNormNode>(ArrayBuilder3<TreeHandle>(child0, child1, child2).array(), 3); }
