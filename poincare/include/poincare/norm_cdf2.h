...
public:
  ...
  static NormCDF2 Builder(Expression child0, Expression child1, Expression child2, Expression child3) { return TreeHandle::FixedArityBuilder<NormCDF2, NormCDF2Node>(ArrayBuilder4<TreeHandle>(child0, child1, child2, child3).array(), 4); }
